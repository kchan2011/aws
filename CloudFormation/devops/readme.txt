...
SET KeyName=kevinchanSMBC
SET sonarqubepassword=test12345
aws cloudformation deploy --template-file C:\downloads\github\aws\CloudFormation\EC2\devops\SonarQube-CrossStack-Update.yml --stack-name CM-SonarQube-Apps-%Env% --parameter-overrides KeyName=%KeyName% Env=%Env% SonarQubePassword=%sonarqubepassword% AppsVolumeProvision=%AppsVolumeProvision%

==============================================
### SonarQube EBS Apps Volume - Prod1a
SET Env=Prod1a
SET Apps=SonarQube
SET EBSVolumeSize=5
...
### SonarQube EBS Apps Volume - Prod1b
SET Env=Prod1b
SET Apps=SonarQube
SET EBSVolumeSize=5
...
###################################################
### New SonarQube Apps Prod setup for 1st time
### using NEW EBS Apps Volume from Above Cloudformation Stack for 1st time
SET AppsVolumeProvision=New
SET AppsVolumeProvision=Update
...
===============
### Update SonarQube EC2 instance and attaching the existing apps volume

SET Env=Prod1a
SET KeyName=kevinchanSMBC
SET sonarqubepassword=test12345
aws cloudformation deploy --template-file C:\downloads\github\aws\CloudFormation\EC2\devops\SonarQube-CrossStack-Update.yml --stack-name CM-SonarQube-%Env% --parameter-overrides KeyName=%KeyName% Env=%Env% SonarQubePassword=%sonarqubepassword%
